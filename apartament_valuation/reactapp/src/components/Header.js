    ...
    <header className='z-50'>
      <div
        className={`w-full border-b ${
          isVisible ? 'fixed top-0 left-0 bg-white shadow-md opacity-100' : 'fixed top-0 left-0 bg-white shadow-md opacity-0'
              ...
              <a onClick={() => scrollToSection(refs.contact)} className="cursor-pointer font-medium text-black">
                ...
                <div class="lg:absolute lg:-translate-x-1/2 lg:inset-y-5 lg:left-1/2">
                    <div class="flex-shrink-0">
                        <h1 className="text-4xl pb-4 font-bold text-gray-800 tracking-widest">apartament valuation</h1>
                    </div>
                </div>
